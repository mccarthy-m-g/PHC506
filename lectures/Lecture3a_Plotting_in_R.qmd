...
A couple "quick and dirty" plots can save you a lot of time.

Plotting is often iterative, and you may make many plots of the same data in an
analysis:
...
e) the "quick and dirty" plot is often a reasonably aesthetically pleasing 
   starting spot
